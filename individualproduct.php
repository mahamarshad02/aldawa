            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index2.html#section-4">ABOUT</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index2.html#section-5">TESTIMONIALS</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index2.html#contactus">CONTACT</a>
                        </li>
                        <!-- <li class="nav-item">
    ...
    <section class="individualproduct">
        ...
        <div class="product">
            <div class="row text-centre px-5 py-5">
                ...
                <div class="col-md-7">
                    <div class="card" style="border: 1px solid; border-color:#3883ab; box-shadow: 0 15px 35px rgba(0,0,0,0.2);">
                        <div class="card-body">
                            ...
                            <form action="cart.php" method="POST">
                                ...
                                <div class="counter">
                                    ...
                                    <button style="border: none;"><input type="submit" style="width: fit-content;" name="addtocart" class="col-md-12 btn  addtocart"
