    ...
    <div class="container-fluid">
        <div class="row justify-content-around">
            <div class="col-sm-9 col-md-6 col-lg-9">
                <table class="table table-bordered text-center" style="background-color:  rgba(56, 131, 171, 0.16); box-shadow: 0 15px 35px rgba(0,0,0,0.2);">
                    <thead class="text-white" style="background-color:#3883ab;">
                        <th>Product Image</th>
                        <th>Product Name</th>
                        <th>Product Price</th>
                        <th>Quantity</th>
            ...
            <div class="col-lg-3" style="background-color: #3883ab;">
                <h3 style="color: #f7f6f6; font-weight:bold">Total</h3>
                <h2 style="color: #f7f6f6;"><?php echo $finaltotal;  ?></h2>
                <a href="checkout.php"><button class="checkoutbtn btn">CHECKOUT</button></a>
                <!-- <a href="https://buy.stripe.com/test_bIY9BZ3Jsak6dpe7ss"><button class="btn">PAY WITH CARD</button></a> -->
